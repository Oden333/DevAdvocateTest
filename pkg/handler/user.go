...
func (h *Handler) get_all_users(c *gin.Context) {
	...
	queryParamsData := []string{"name", "surname", "patronymic"}
	...
	logrus.Debugln("Pagination info for get request", page, pageNum, offset)
	...
	*/
	c.JSON(http.StatusOK, gin.H{
		"people": people,
		"pagination": helper.PaginationData{
			NextPage:   page + 1,
			PrevPage:   page - 1,
			CurrPage:   page,
